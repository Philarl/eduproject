...
//		document.getElementById("suggestionsubject").innerText = '인공지능기초,공학일반,교육학';
		...
		document.getElementById("prior1-1.1").innerText = '87';
		document.getElementById("prior1-1.2").innerText = '92';
		document.getElementById("prior1-1.3").innerText = '83';
		document.getElementById("prior1-2.1").innerText = '71';
		document.getElementById("prior1-2.2").innerText = '75';
		document.getElementById("prior1-2.3").innerText = '63';
		document.getElementById("prior1-3.1").innerText = '55';
		document.getElementById("prior1-3.2").innerText = '59';
		document.getElementById("prior1-3.3").innerText = '44';

		document.getElementById("prior2-1.1").innerText = '90';
		document.getElementById("prior2-1.2").innerText = '86';
		document.getElementById("prior2-1.3").innerText = '76';
		document.getElementById("prior2-2.1").innerText = '75';
		document.getElementById("prior2-2.2").innerText = '62';
		document.getElementById("prior2-2.3").innerText = '56';
		document.getElementById("prior2-3.1").innerText = '61';
		document.getElementById("prior2-3.2").innerText = '71';
		document.getElementById("prior2-3.3").innerText = '37';

		document.getElementById("prior3-1.1").innerText = '87';
		document.getElementById("prior3-1.2").innerText = '90';
		document.getElementById("prior3-1.3").innerText = '70';
		document.getElementById("prior3-2.1").innerText = '68';
		document.getElementById("prior3-2.2").innerText = '71';
		document.getElementById("prior3-2.3").innerText = '51';
		document.getElementById("prior3-3.1").innerText = '50';
		document.getElementById("prior3-3.2").innerText = '78';
		document.getElementById("prior3-3.3").innerText = '32';

		document.getElementById("prior4-1.1").innerText = '95';
		document.getElementById("prior4-1.2").innerText = '93';
		document.getElementById("prior4-1.3").innerText = '84';
		document.getElementById("prior4-2.1").innerText = '76';
		document.getElementById("prior4-2.2").innerText = '75';
		document.getElementById("prior4-2.3").innerText = '63';
		document.getElementById("prior4-3.1").innerText = '59';
		document.getElementById("prior4-3.2").innerText = '81';
		document.getElementById("prior4-3.3").innerText = '42';

		document.getElementById("prior5-1.1").innerText = '90';
		document.getElementById("prior5-1.2").innerText = '90';
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '72';
		document.getElementById("prior5-2.2").innerText = '71';
		document.getElementById("prior5-2.3").innerText = '85';
		document.getElementById("prior5-3.1").innerText = '55';
		document.getElementById("prior5-3.2").innerText = '78';
		document.getElementById("prior5-3.3").innerText = '68';
...
//		document.getElementById("suggestionsubject").innerText = '철학, 심리학, 교육학, 보건, 논술';
		document.getElementById("explanationword1").innerHTML = '<p>최근,  노원구 소재 대 다수의 고등학교에서 대입률을 높이기 위해 학습역량증진 뿐만 아니라, 학생부 기록까지 신경을 쓰고 있습니다. 따라서 신학기에 자신이 가진 에너지 모두를 학업에 쏟아준다면 학습우수생, 생활모범생으로 인정받을 수 있으니 학교생활 역전의 기회를 놓치지 않길 바랍니다.</p>';
		document.getElementById("prior1-1.1").innerText = '90';
		document.getElementById("prior1-1.2").innerText = '100';
		document.getElementById("prior1-1.3").innerText = '82';
		document.getElementById("prior1-2.1").innerText = '73';
		document.getElementById("prior1-2.2").innerText = '82';
		document.getElementById("prior1-2.3").innerText = '63';
		document.getElementById("prior1-3.1").innerText = '56';
		document.getElementById("prior1-3.2").innerText = '90';
		document.getElementById("prior1-3.3").innerText = '45';

		document.getElementById("prior2-1.1").innerText = '86';
		document.getElementById("prior2-1.2").innerText = '80';
		document.getElementById("prior2-1.3").innerText = '80';
		document.getElementById("prior2-2.1").innerText = '70';
		document.getElementById("prior2-2.2").innerText = '64';
		document.getElementById("prior2-2.3").innerText = '62';
		document.getElementById("prior2-3.1").innerText = '54';
		document.getElementById("prior2-3.2").innerText = '70';
		document.getElementById("prior2-3.3").innerText = '46';

		document.getElementById("prior3-1.1").innerText = '79';
		document.getElementById("prior3-1.2").innerText = '84';
		document.getElementById("prior3-1.3").innerText = '86';
		document.getElementById("prior3-2.1").innerText = '60';
		document.getElementById("prior3-2.2").innerText = '65';
		document.getElementById("prior3-2.3").innerText = '62';
		document.getElementById("prior3-3.1").innerText = '42';
		document.getElementById("prior3-3.2").innerText = '72';
		document.getElementById("prior3-3.3").innerText = '39';

		document.getElementById("prior4-1.1").innerText = '92';
		document.getElementById("prior4-1.2").innerText = '86';
		document.getElementById("prior4-1.3").innerText = '80';
		document.getElementById("prior4-2.1").innerText = '74';
		document.getElementById("prior4-2.2").innerText = '68';
		document.getElementById("prior4-2.3").innerText = '60';
		document.getElementById("prior4-3.1").innerText = '57';
		document.getElementById("prior4-3.2").innerText = '75';
		document.getElementById("prior4-3.3").innerText = '40';

		document.getElementById("prior5-1.1").innerText = '84';
		document.getElementById("prior5-1.2").innerText = '85';
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '66';
		document.getElementById("prior5-2.2").innerText = '68';
		document.getElementById("prior5-2.3").innerText = '83';
		document.getElementById("prior5-3.1").innerText = '49';
...
//		document.getElementById("suggestionsubject").innerText = '입체조형, 인공지능기초, 종교학/논리학 중 택일(필수)';
		document.getElementById("explanationword1").innerHTML = '<p>최근,  노원구 소재 대 다수의 고등학교에서 대입률을 높이기 위해 학습역량증진 뿐만 아니라, 학생부 기록까지 신경을 쓰고 있습니다. 따라서 신학기에 자신이 가진 에너지 모두를 학업에 쏟아준다면 학습우수생, 생활모범생으로 인정받을 수 있으니 학교생활 역전의 기회를 놓치지 않길 바랍니다.</p>';
		document.getElementById("prior1-1.1").innerText = '86';
		document.getElementById("prior1-1.2").innerText = '96';
		document.getElementById("prior1-1.3").innerText = '90';
		document.getElementById("prior1-2.1").innerText = '75';
		document.getElementById("prior1-2.2").innerText = '83';
		document.getElementById("prior1-2.3").innerText = '74';
		document.getElementById("prior1-3.1").innerText = '65';
		document.getElementById("prior1-3.2").innerText = '88';
		document.getElementById("prior1-3.3").innerText = '58';

		document.getElementById("prior2-1.1").innerText = '74';
		document.getElementById("prior2-1.2").innerText = '88';
		document.getElementById("prior2-1.3").innerText = '84';
		document.getElementById("prior2-2.1").innerText = '57';
		document.getElementById("prior2-2.2").innerText = '71';
		document.getElementById("prior2-2.3").innerText = '66';
		document.getElementById("prior2-3.1").innerText = '42';
		document.getElementById("prior2-3.2").innerText = '77';
		document.getElementById("prior2-3.3").innerText = '50';

		document.getElementById("prior3-1.1").innerText = '88';
		document.getElementById("prior3-1.2").innerText = '88';
		document.getElementById("prior3-1.3").innerText = '88';
		document.getElementById("prior3-2.1").innerText = '72';
		document.getElementById("prior3-2.2").innerText = '73';
		document.getElementById("prior3-2.3").innerText = '73';
		document.getElementById("prior3-3.1").innerText = '57';
		...
		document.getElementById("prior4-1.3").innerText = '72';
		document.getElementById("prior4-2.1").innerText = '84';
		document.getElementById("prior4-2.2").innerText = '78';
		document.getElementById("prior4-2.3").innerText = '56';
		document.getElementById("prior4-3.1").innerText = '72';
		...
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '78';
		document.getElementById("prior5-2.2").innerText = '77';
		document.getElementById("prior5-2.3").innerText = '88';
		document.getElementById("prior5-3.1").innerText = '63';
		document.getElementById("prior5-3.2").innerText = '82';
		document.getElementById("prior5-3.3").innerText = '75';
...
//		document.getElementById("suggestionsubject").innerText = '교육학,진로와직업,환경,논술(필수)';
		...
		document.getElementById("prior1-1.2").innerText = '95';
		document.getElementById("prior1-1.3").innerText = '86';
		document.getElementById("prior1-2.1").innerText = '85';
		document.getElementById("prior1-2.2").innerText = '78';
		document.getElementById("prior1-2.3").innerText = '68';
		document.getElementById("prior1-3.1").innerText = '73';
		document.getElementById("prior1-3.2").innerText = '84';
		document.getElementById("prior1-3.3").innerText = '52';

		document.getElementById("prior2-1.1").innerText = '92';
		document.getElementById("prior2-1.2").innerText = '91';
		document.getElementById("prior2-1.3").innerText = '68';
		document.getElementById("prior2-2.1").innerText = '77';
		document.getElementById("prior2-2.2").innerText = '66';
		document.getElementById("prior2-2.3").innerText = '51';
		document.getElementById("prior2-3.1").innerText = '63';
		document.getElementById("prior2-3.2").innerText = '75';
		document.getElementById("prior2-3.3").innerText = '36';

		document.getElementById("prior3-1.1").innerText = '89';
		document.getElementById("prior3-1.2").innerText = '86';
		document.getElementById("prior3-1.3").innerText = '70';
		document.getElementById("prior3-2.1").innerText = '76';
		document.getElementById("prior3-2.2").innerText = '68';
		document.getElementById("prior3-2.3").innerText = '52';
		document.getElementById("prior3-3.1").innerText = '64';
		document.getElementById("prior3-3.2").innerText = '75';
		document.getElementById("prior3-3.3").innerText = '35';

		document.getElementById("prior4-1.1").innerText = '95';
		document.getElementById("prior4-1.2").innerText = '91';
		document.getElementById("prior4-1.3").innerText = '88';
		document.getElementById("prior4-2.1").innerText = '82';
		document.getElementById("prior4-2.2").innerText = '74';
		document.getElementById("prior4-2.3").innerText = '66';
		document.getElementById("prior4-3.1").innerText = '69';
		document.getElementById("prior4-3.2").innerText = '80';
		document.getElementById("prior4-3.3").innerText = '46';

		document.getElementById("prior5-1.1").innerText = '100';
		document.getElementById("prior5-1.2").innerText = '92';
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '81';
		document.getElementById("prior5-2.2").innerText = '72';
		document.getElementById("prior5-2.3").innerText = '85';
		document.getElementById("prior5-3.1").innerText = '63';
...
//		document.getElementById("suggestionsubject").innerText = '프랑스어,실용경제,철학,교육학,진로와직업,심리학,환경,논술';
		...
		document.getElementById("prior1-1.2").innerText = '100';
		document.getElementById("prior1-1.3").innerText = '89';
		...
		document.getElementById("prior1-3.3").innerText = '48';

		document.getElementById("prior2-1.1").innerText = '90';
		document.getElementById("prior2-1.2").innerText = '91';
		document.getElementById("prior2-1.3").innerText = '92';
		document.getElementById("prior2-2.1").innerText = '78';
		document.getElementById("prior2-2.2").innerText = '70';
		document.getElementById("prior2-2.3").innerText = '69';
		document.getElementById("prior2-3.1").innerText = '67';
		document.getElementById("prior2-3.2").innerText = '78';
		document.getElementById("prior2-3.3").innerText = '47';
		...
		document.getElementById("prior3-2.2").innerText = '74';
		document.getElementById("prior3-2.3").innerText = '60';
		document.getElementById("prior3-3.1").innerText = '68';
		document.getElementById("prior3-3.2").innerText = '82';
		document.getElementById("prior3-3.3").innerText = '39';

		document.getElementById("prior4-1.1").innerText = '96';
		document.getElementById("prior4-1.2").innerText = '90';
		document.getElementById("prior4-1.3").innerText = '80';
		document.getElementById("prior4-2.1").innerText = '86';
		document.getElementById("prior4-2.2").innerText = '72';
		document.getElementById("prior4-2.3").innerText = '61';
		document.getElementById("prior4-3.1").innerText = '77';
		document.getElementById("prior4-3.2").innerText = '79';
		document.getElementById("prior4-3.3").innerText = '43';

		document.getElementById("prior5-1.1").innerText = '95';
		document.getElementById("prior5-1.2").innerText = '85';
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '79';
		document.getElementById("prior5-2.2").innerText = '67';
		document.getElementById("prior5-2.3").innerText = '87';
		document.getElementById("prior5-3.1").innerText = '65';
		document.getElementById("prior5-3.2").innerText = '73';
		document.getElementById("prior5-3.3").innerText = '69';
		document.getElementById("textCal1").innerHTML = `<span class="text-box">1. 자율활동</span>
...
//		document.getElementById("suggestionsubject").innerText = '인공지능기초,프로그래밍,식품안전과건강,심리학,교육학,보건,논술';
		document.getElementById("explanationword1").innerHTML = '<p>최근,  노원구 소재 대 다수의 고등학교에서 대입률을 높이기 위해 학습역량증진 뿐만 아니라, 학생부 기록까지 신경을 쓰고 있습니다. 따라서 신학기에 자신이 가진 에너지 모두를 학교활동에 쏟아준다면 학습우수생, 생활모범생으로 인정받게 될 것 입니다.</p><p>3년 내내 주도적으로 생활하는 학창시절을 보내게 되고 이 부분이 목표대학합격에도 긍정적 영향을 주게됩니다. 어느학교에 배정되든지 신학기 초반 연간학교일정과 시험일정에 주의하여 사전에 준비해주세요</p>';
		document.getElementById("prior1-1.1").innerText = '91';
		document.getElementById("prior1-1.2").innerText = '87';
		document.getElementById("prior1-1.3").innerText = '87';
		document.getElementById("prior1-2.1").innerText = '81';
		document.getElementById("prior1-2.2").innerText = '74';
		document.getElementById("prior1-2.3").innerText = '73';
		document.getElementById("prior1-3.1").innerText = '71';
		document.getElementById("prior1-3.2").innerText = '79';
		document.getElementById("prior1-3.3").innerText = '59';

		document.getElementById("prior2-1.1").innerText = '80';
		document.getElementById("prior2-1.2").innerText = '77';
		document.getElementById("prior2-1.3").innerText = '90';
		document.getElementById("prior2-2.1").innerText = '69';
		document.getElementById("prior2-2.2").innerText = '63';
		document.getElementById("prior2-2.3").innerText = '71';
		document.getElementById("prior2-3.1").innerText = '59';
		document.getElementById("prior2-3.2").innerText = '68';
		document.getElementById("prior2-3.3").innerText = '52';

		document.getElementById("prior3-1.1").innerText = '88';
		document.getElementById("prior3-1.2").innerText = '90';
		document.getElementById("prior3-1.3").innerText = '79';
		document.getElementById("prior3-2.1").innerText = '75';
		document.getElementById("prior3-2.2").innerText = '76';
		document.getElementById("prior3-2.3").innerText = '58';
		document.getElementById("prior3-3.1").innerText = '63';
		document.getElementById("prior3-3.2").innerText = '81';
		document.getElementById("prior3-3.3").innerText = '39';

		document.getElementById("prior4-1.1").innerText = '94';
		document.getElementById("prior4-1.2").innerText = '86';
		document.getElementById("prior4-1.3").innerText = '85';
		document.getElementById("prior4-2.1").innerText = '84';
		document.getElementById("prior4-2.2").innerText = '69';
		document.getElementById("prior4-2.3").innerText = '68';
		document.getElementById("prior4-3.1").innerText = '74';
		document.getElementById("prior4-3.2").innerText = '76';
		document.getElementById("prior4-3.3").innerText = '51';

		document.getElementById("prior5-1.1").innerText = '86';
		document.getElementById("prior5-1.2").innerText = '68';
		document.getElementById("prior5-1.3").innerText = '100';
		document.getElementById("prior5-2.1").innerText = '71';
		document.getElementById("prior5-2.2").innerText = '49';
		document.getElementById("prior5-2.3").innerText = '85';
		document.getElementById("prior5-3.1").innerText = '56';
		document.getElementById("prior5-3.2").innerText = '56';
		document.getElementById("prior5-3.3").innerText = '70';
		document.getElementById("textCal1").innerHTML = `<span class="text-box">1. 자율활동</span>
...
//		document.getElementById("suggestionsubject").innerText = '미술,일본어,중국어,논술';
		...
		document.getElementById("prior1-1.2").innerText = '89';
		document.getElementById("prior1-1.3").innerText = '83';
		document.getElementById("prior1-2.1").innerText = '77';
		document.getElementById("prior1-2.2").innerText = '74';
		document.getElementById("prior1-2.3").innerText = '64';
		document.getElementById("prior1-3.1").innerText = '62';
		document.getElementById("prior1-3.2").innerText = '79';
		document.getElementById("prior1-3.3").innerText = '46';

		document.getElementById("prior2-1.1").innerText = '85';
		document.getElementById("prior2-1.2").innerText = '85';
		document.getElementById("prior2-1.3").innerText = '78';
		document.getElementById("prior2-2.1").innerText = '72';
		document.getElementById("prior2-2.2").innerText = '69';
		document.getElementById("prior2-2.3").innerText = '60';
		document.getElementById("prior2-3.1").innerText = '59';
		document.getElementById("prior2-3.2").innerText = '75';
		document.getElementById("prior2-3.3").innerText = '42';

		document.getElementById("prior3-1.1").innerText = '90';
		document.getElementById("prior3-1.2").innerText = '89';
		document.getElementById("prior3-1.3").innerText = '72';
		document.getElementById("prior3-2.1").innerText = '76';
		document.getElementById("prior3-2.2").innerText = '72';
		document.getElementById("prior3-2.3").innerText = '52';
		document.getElementById("prior3-3.1").innerText = '62';
		document.getElementById("prior3-3.2").innerText = '78';
		document.getElementById("prior3-3.3").innerText = '33';

		document.getElementById("prior4-1.1").innerText = '94';
		document.getElementById("prior4-1.2").innerText = '88';
		document.getElementById("prior4-1.3").innerText = '77';
		document.getElementById("prior4-2.1").innerText = '80';
		document.getElementById("prior4-2.2").innerText = '71';
		document.getElementById("prior4-2.3").innerText = '55';
		document.getElementById("prior4-3.1").innerText = '68';
		document.getElementById("prior4-3.2").innerText = '77';
		document.getElementById("prior4-3.3").innerText = '34';

		document.getElementById("prior5-1.1").innerText = '92';
		document.getElementById("prior5-1.2").innerText = '89';
		document.getElementById("prior5-1.3").innerText = '86';
		document.getElementById("prior5-2.1").innerText = '73';
		document.getElementById("prior5-2.2").innerText = '74';
		document.getElementById("prior5-2.3").innerText = '71';
		document.getElementById("prior5-3.1").innerText = '56';
		document.getElementById("prior5-3.2").innerText = '79';
		document.getElementById("prior5-3.3").innerText = '57';
		document.getElementById("textCal1").innerHTML = `<span class="text-box">1. 자율활동</span>
...
//		document.getElementById("suggestionsubject").innerText = '단체운동,체육전공실기기초,육상운동,체조운동,체육전공실기심화, 연극의이해(필수), 인공지능기초,인공지능과피지컬컴퓨팅,프로그래밍,정보과제연구,인공지능과미래사회,독일어,심리학,진로와직업,논술,보건,환경,교육학';
		...
		document.getElementById("prior1-2.2").innerText = '82';
		document.getElementById("prior1-2.3").innerText = '73';
		document.getElementById("prior1-3.1").innerText = '69';
		document.getElementById("prior1-3.2").innerText = '86';
		document.getElementById("prior1-3.3").innerText = '57';

		document.getElementById("prior2-1.1").innerText = '77';
		document.getElementById("prior2-1.2").innerText = '83';
		document.getElementById("prior2-1.3").innerText = '85';
		document.getElementById("prior2-2.1").innerText = '66';
		document.getElementById("prior2-2.2").innerText = '73';
		document.getElementById("prior2-2.3").innerText = '69';
		document.getElementById("prior2-3.1").innerText = '55';
		document.getElementById("prior2-3.2").innerText = '77';
		document.getElementById("prior2-3.3").innerText = '55';
		...
		document.getElementById("prior3-2.2").innerText = '76';
		document.getElementById("prior3-2.3").innerText = '61';
		document.getElementById("prior3-3.1").innerText = '65';
		document.getElementById("prior3-3.2").innerText = '81';
		document.getElementById("prior3-3.3").innerText = '46';

		document.getElementById("prior4-1.1").innerText = '94';
		document.getElementById("prior4-1.2").innerText = '87';
		document.getElementById("prior4-1.3").innerText = '84';
		document.getElementById("prior4-2.1").innerText = '84';
		document.getElementById("prior4-2.2").innerText = '71';
		document.getElementById("prior4-2.3").innerText = '69';
		document.getElementById("prior4-3.1").innerText = '75';
		document.getElementById("prior4-3.2").innerText = '77';
		document.getElementById("prior4-3.3").innerText = '55';

		document.getElementById("prior5-1.1").innerText = '92';
		document.getElementById("prior5-1.2").innerText = '86';
		document.getElementById("prior5-1.3").innerText = '96';
		document.getElementById("prior5-2.1").innerText = '77';
		document.getElementById("prior5-2.2").innerText = '70';
		document.getElementById("prior5-2.3").innerText = '80';
		document.getElementById("prior5-3.1").innerText = '63';
...
//		document.getElementById("suggestionsubject").innerText = '스포츠생활(필수),체육과진로탐구, 음악연주,미술창작, 프로그래밍(필수), 진로와직업,심리학,논술(필수)';
		...
		document.getElementById("prior1-2.1").innerText = '83';
		document.getElementById("prior1-2.2").innerText = '84';
		document.getElementById("prior1-2.3").innerText = '74';
		document.getElementById("prior1-3.1").innerText = '71';
		document.getElementById("prior1-3.2").innerText = '89';
		document.getElementById("prior1-3.3").innerText = '57';
		...
		document.getElementById("prior2-1.3").innerText = '84';
		document.getElementById("prior2-2.1").innerText = '77';
		document.getElementById("prior2-2.2").innerText = '74';
		document.getElementById("prior2-2.3").innerText = '66';
		document.getElementById("prior2-3.1").innerText = '65';
		document.getElementById("prior2-3.2").innerText = '78';
		document.getElementById("prior2-3.3").innerText = '49';

		document.getElementById("prior3-1.1").innerText = '94';
		document.getElementById("prior3-1.2").innerText = '92';
		document.getElementById("prior3-1.3").innerText = '84';
		document.getElementById("prior3-2.1").innerText = '79';
		document.getElementById("prior3-2.2").innerText = '73';
		document.getElementById("prior3-2.3").innerText = '67';
		document.getElementById("prior3-3.1").innerText = '64';
		document.getElementById("prior3-3.2").innerText = '80';
		document.getElementById("prior3-3.3").innerText = '50';

		document.getElementById("prior4-1.1").innerText = '94';
		document.getElementById("prior4-1.2").innerText = '100';
		document.getElementById("prior4-1.3").innerText = '85';
		document.getElementById("prior4-2.1").innerText = '83';
		document.getElementById("prior4-2.2").innerText = '83';
		document.getElementById("prior4-2.3").innerText = '66';
		document.getElementById("prior4-3.1").innerText = '71';
		document.getElementById("prior4-3.2").innerText = '90';
		document.getElementById("prior4-3.3").innerText = '47';

		document.getElementById("prior5-1.1").innerText = '96';
		document.getElementById("prior5-1.2").innerText = '91';
		document.getElementById("prior5-1.3").innerText = '94';
		document.getElementById("prior5-2.1").innerText = '83';
		document.getElementById("prior5-2.2").innerText = '75';
		document.getElementById("prior5-2.3").innerText = '81';
		document.getElementById("prior5-3.1").innerText = '70';
...
//		document.getElementById("suggestionsubject").innerText = '체육탐구, 공학일반,창의경영, 종교학/철학 중 택일,논술(필수),실용경제,환경';
		...
		document.getElementById("prior1-1.3").innerText = '82';
		document.getElementById("prior1-2.1").innerText = '81';
		document.getElementById("prior1-2.2").innerText = '81';
		document.getElementById("prior1-2.3").innerText = '62';
		document.getElementById("prior1-3.1").innerText = '70';
		...
		document.getElementById("prior2-1.3").innerText = '81';
		document.getElementById("prior2-2.1").innerText = '69';
		document.getElementById("prior2-2.2").innerText = '74';
		document.getElementById("prior2-2.3").innerText = '62';
		document.getElementById("prior2-3.1").innerText = '55';
		document.getElementById("prior2-3.2").innerText = '79';
		document.getElementById("prior2-3.3").innerText = '43';

		document.getElementById("prior3-1.1").innerText = '85';
		document.getElementById("prior3-1.2").innerText = '89';
		document.getElementById("prior3-1.3").innerText = '77';
		document.getElementById("prior3-2.1").innerText = '72';
		document.getElementById("prior3-2.2").innerText = '73';
		document.getElementById("prior3-2.3").innerText = '57';
		document.getElementById("prior3-3.1").innerText = '60';
		document.getElementById("prior3-3.2").innerText = '79';
		document.getElementById("prior3-3.3").innerText = '39';

		document.getElementById("prior4-1.1").innerText = '90';
		document.getElementById("prior4-1.2").innerText = '95';
		document.getElementById("prior4-1.3").innerText = '92';
		document.getElementById("prior4-2.1").innerText = '78';
		document.getElementById("prior4-2.2").innerText = '78';
		document.getElementById("prior4-2.3").innerText = '72';
		document.getElementById("prior4-3.1").innerText = '66';
		document.getElementById("prior4-3.2").innerText = '85';
		document.getElementById("prior4-3.3").innerText = '54';

		document.getElementById("prior5-1.1").innerText = '87';
		document.getElementById("prior5-1.2").innerText = '90';
		document.getElementById("prior5-1.3").innerText = '83';
		document.getElementById("prior5-2.1").innerText = '72';
		document.getElementById("prior5-2.2").innerText = '74';
		document.getElementById("prior5-2.3").innerText = '66';
		document.getElementById("prior5-3.1").innerText = '58';
		document.getElementById("prior5-3.2").innerText = '80';
		document.getElementById("prior5-3.3").innerText = '51';
		document.getElementById("textCal1").innerHTML = `<span class="text-box">1. 자율활동</span>
...
//		document.getElementById("suggestionsubject").innerText = '운동과건강, 사물인터넷,데이터과학과머신러닝,인공지능기초, 진로와직업(필수),환경,실용경제';
		...
		document.getElementById("prior1-1.2").innerText = '85';
		document.getElementById("prior1-1.3").innerText = '81';
		document.getElementById("prior1-2.1").innerText = '81';
		document.getElementById("prior1-2.2").innerText = '71';
		document.getElementById("prior1-2.3").innerText = '64';
		document.getElementById("prior1-3.1").innerText = '70';
		...
		document.getElementById("prior2-1.1").innerText = '90';
		document.getElementById("prior2-1.2").innerText = '83';
		document.getElementById("prior2-1.3").innerText = '75';
		document.getElementById("prior2-2.1").innerText = '76';
		document.getElementById("prior2-2.2").innerText = '69';
		document.getElementById("prior2-2.3").innerText = '56';
		document.getElementById("prior2-3.1").innerText = '64';
		document.getElementById("prior2-3.2").innerText = '74';
		document.getElementById("prior2-3.3").innerText = '38';

		document.getElementById("prior3-1.1").innerText = '90';
		document.getElementById("prior3-1.2").innerText = '94';
		document.getElementById("prior3-1.3").innerText = '72';
		document.getElementById("prior3-2.1").innerText = '74';
		document.getElementById("prior3-2.2").innerText = '78';
		document.getElementById("prior3-2.3").innerText = '54';
		document.getElementById("prior3-3.1").innerText = '59';
		document.getElementById("prior3-3.2").innerText = '84';
		document.getElementById("prior3-3.3").innerText = '36';

		document.getElementById("prior4-1.1").innerText = '88';
		document.getElementById("prior4-1.2").innerText = '87';
		document.getElementById("prior4-1.3").innerText = '75';
		document.getElementById("prior4-2.1").innerText = '72';
		document.getElementById("prior4-2.2").innerText = '69';
		document.getElementById("prior4-2.3").innerText = '53';
		document.getElementById("prior4-3.1").innerText = '57';
		document.getElementById("prior4-3.2").innerText = '75';
		document.getElementById("prior4-3.3").innerText = '33';
		...
		document.getElementById("prior5-3.1").innerText = '65';
		document.getElementById("prior5-3.2").innerText = '80';
		document.getElementById("prior5-3.3").innerText = '58';
//		document.getElementById("textCal1").innerHTML = ``;
//		document.getElementById("textCal2").innerHTML = ``;
		$('#textCal1').parents('.img7area').remove();
		$('#textCal2').parents('.img7area').remove();
