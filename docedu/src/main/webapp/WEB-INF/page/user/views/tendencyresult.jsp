...
<body>
	<div class="mainbody">
		<div class="tendencyresultbody">
			<div class="imgarea">
				...
				<img class="mainheaderimg1" alt="img1" src="/resources/img/user/tendencyfirst.png">
		...
		<div class="noprint" style="text-align: center;">
			<button type="button" id="getNext">다른 학습법 찾기</button>
		</div>
	</div>
	...
	const aresult = (parseFloat(parseFloat(a1)+parseFloat(a3)+parseFloat(a4)+parseFloat(a5)+parseFloat(a7)+parseFloat(a8)+parseFloat(a10)+parseFloat(a12))/8).toFixed(1);
	const hresult = (parseFloat(parseFloat(h1)+parseFloat(h4)+parseFloat(h5)+parseFloat(h6)+parseFloat(h7)+parseFloat(h8)+parseFloat(h9)+parseFloat(h10)+parseFloat(h13)+parseFloat(h14))/10).toFixed(1);
	const rresult = (parseFloat(parseFloat(r1)+parseFloat(r2)+parseFloat(r3)+parseFloat(r4)+parseFloat(r6))/5).toFixed(1);
	const eresult = (parseFloat(parseFloat(e1)+parseFloat(e2)+parseFloat(e3)+parseFloat(e6)+parseFloat(e8)+parseFloat(e9)+parseFloat(e10)+parseFloat(e11)+parseFloat(e13)+parseFloat(e14)+parseFloat(e15)+parseFloat(e16)+parseFloat(e18))/13).toFixed(1);
	if(aresult<=40){
		document.getElementById("light1").style.backgroundColor="red";
		document.getElementById("light2").style.backgroundColor="white";
		document.getElementById("light3").style.backgroundColor="white";
		document.getElementById("traffictext1").innerText="심각";
	}else if(aresult<=50){
		document.getElementById("light1").style.backgroundColor="white";
		document.getElementById("light2").style.backgroundColor="orange";
		document.getElementById("light3").style.backgroundColor="white";
	...
	if(hresult<=40){
	    ...
	    document.getElementById("light6").style.backgroundColor="white";
	    document.getElementById("traffictext2").innerText="심각";
	}else if(hresult<=50){
	    document.getElementById("light4").style.backgroundColor="white";
	    document.getElementById("light5").style.backgroundColor="orange";
	    document.getElementById("light6").style.backgroundColor="white";
	...
	if(rresult<=40){
	    ...
	    document.getElementById("light9").style.backgroundColor="white";
	    document.getElementById("traffictext3").innerText="심각";
	}else if(rresult<=50){
	    document.getElementById("light7").style.backgroundColor="white";
	    document.getElementById("light8").style.backgroundColor="orange";
	    document.getElementById("light9").style.backgroundColor="white";
	...
	if(eresult<=40){
	    ...
	    document.getElementById("light12").style.backgroundColor="white";
	    document.getElementById("traffictext4").innerText="심각";
	}else if(eresult<=50){
	    document.getElementById("light10").style.backgroundColor="white";
	    document.getElementById("light11").style.backgroundColor="orange";
	    document.getElementById("light12").style.backgroundColor="white";
	...
	e8
	*/
	let aarr = [a1, a3, a4, a5, a7, a10];
	let aarr2 = [a8, a12];
	let harr = [h1, h4, h5, h6, h7, h8, h9, h10, h13];
	let rarr = [r1, r2, r3, r4, r6]; 
	let earr = [e1, e2, e3, e6, e9, e10, e11, e13, e14, e15, e16, e18];
	const aset = new Set(aarr);
	const uniquea = [...aset];
	const aset2 = new Set(aarr2);
	const uniquea2 = [...aset2];
	...
	uniquea2.sort(function(a, b)  {
		  return b - a;
	});
	uniquea.concat(uniquea2);
	...
	e8
	*/
	const amax = Math.max(a1, a3, a4, a5, a7, a10);
	if(amax == 0) amax = Math.max(a1, a3, a4, a5, a7, a8, a10, a12);
	const hmax = Math.max(h1, h4, h5, h6, h7, h8, h9, h10, h13);
	if(hmax == 0) hmax = Math.max(h1, h4, h5, h6, h7, h8, h9, h10, h13, h14);
	const rmax = Math.max(r1, r2, r3, r4, r6);
	if(rmax == 0) rmax = Math.max(r1, r2, r3, r4, r6);
	const emax = Math.max(e1, e2, e3, e6, e9, e10, e11, e13, e14, e15, e16, e18);
	if(emax == 0) emax = Math.max(e1, e2, e3, e6, e8, e9, e10, e11, e13, e14, e15, e16, e18);
	var aval = "";
	var hval = "";
	var rval = "";
	var eval = "";
...
//	            '필기왕 학습'
	        ...
	        datasets: [{
	            label: '분석능력',
	            data: [a1, a3, a4, a5, a7, a8, a10, a12],
	            fill: true,
...
//	                '스탬프학습',
	              ...
	              datasets: [{
	                label: '감정능력',
	                data: [h1, h4, h5, h6, h7, h8, h9, h10, h13, h14],
	                fill: true,
	                backgroundColor: 'rgba(219, 244, 253, 0.4)',
	                borderColor: '#4DC9F6',
	                pointBackgroundColor: '#4DC9F6',
...
//	            '엑티비티학습',
	    ...
	    if(rmax==r1){
	        ...
	        document.getElementById("upperimg1").innerHTML="<img src='/resources/img/user/tendencyimg/적성테스트결과imgr04.png'>";
	    ...
	    if(uniquer[1]==r1){
	        ...
	        document.getElementById("upperimg2").innerHTML="<img src='/resources/img/user/tendencyimg/적성테스트결과imgr04.png'>";
...
//	            '포트폴리오 학습'
	        ...
	        datasets: [{
	            label: '창의능력',
	            data: [e1, e2, e3, e6, e8, e9, e10, e11, e13, e14, e15, e16, e18],
	            fill: true,
	            backgroundColor: 'rgba(219, 244, 253, 0.4)',
	            borderColor: '#4DC9F6',
	            pointBackgroundColor: '#4DC9F6',
...
//	            '포트폴리오 학습'
	...
	$(document).ready(function(){
		...
		$('#getNext').click(function() {
			if (!confirm("기존 학습법을 마치고 다음 학습법으로 넘어가시겠습니까?")) return;
			location.href="/tendencyGetNext.do?tendency_seq=" + "${tendencyresult.tendency_seq}" + "&aval=" + aval + "&aval2=" + aval2 + "&hval=" + hval + "&hval2=" + hval2 + "&rval=" + rval + "&rval2=" + rval2 + "&eval=" + eval + "&eval2=" + eval2;
		});
	})
	</script>
</body>
