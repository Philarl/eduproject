...
<body>
	<div class="bodydiv">
		...
		<div class="name">
			<input style="border: none; background: transparent; height: 140px; font-size: 50px;" type="text" id="schoolmatch_name">
		</div>
		<div class="school">
			<input style="border: none; background: transparent; height: 140px; width:450px; font-size: 50px;" type="text" id="schoolmatch_school">
			<span style="font-size: 50px;">&nbsp;/&nbsp;</span>
			<input style="border: none; background: transparent; height: 140px; width:450px; font-size: 50px;" type="text" id="schoolmatch_grade">
		</div>
		<div class="phone">
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_phone1">
			<span style="font-size: 50px;">&nbsp;-&nbsp;</span>
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_phone2">
			<span style="font-size: 50px;">&nbsp;-&nbsp;</span>
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_phone3">
		</div>
		<div class="parentphone">
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_parentphone1">
			<span style="font-size: 50px;">&nbsp;-&nbsp;</span>
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_parentphone2">
			<span style="font-size: 50px;">&nbsp;-&nbsp;</span>
			<input style="border: none; background: transparent; height: 140px; width:250px; font-size: 50px;" type="text" id="schoolmatch_parentphone3">
		</div>
	</div>
	<div class="mainpage">
		<div class="agree">
		...
		<div class="interestgirl">
			...
			<input type="checkbox" class="girlcheck" name="girlcheck" value="둔촌고"> 영파여고 
			<input type="checkbox" class="girlcheck" name="girlcheck" value="한영고"> 창덕여고 
			<input type="checkbox" class="girlcheck" name="girlcheck" value="둔촌고"> 둔촌고 
			<input type="checkbox" class="girlcheck" name="girlcheck" value="한영고"> 한영고 
		...
		<div class="interestboy">
			...
			<input type="checkbox" class="boycheck" name="boycheck" value="동북고"> 동북고 
			<input type="checkbox" class="boycheck" name="boycheck" value="둔촌고"> 둔촌고 
			<input type="checkbox" class="boycheck" name="boycheck" value="보성고"> 보성고 
			<input type="checkbox" class="boycheck" name="boycheck" value="한영고"> 한영고 
			<input type="checkbox" class="boycheck" name="boycheck" value="잠실고"> 잠실고 
	...
	$(document).ready(function(){
		$('.finishbtn').click(function(){
			...
			*/
			...
			var doonchonplus = 0;
			var hanyeongplus = 0;
			var yeongpawomenplus = 0;
			var changdeokwomenplus = 0;
			//var yonghwaplus = 0;
			var jamsilplus = 0;
			var dongbukplus = 0;
			var boseongplus = 0;
			if(girlcheck.includes('둔촌고')){doonchonplus = 10};
			if(girlcheck.includes('한영고')){hanyeongplus = 10};
			if(boycheck.includes('둔촌고')){doonchonplus = 10};
			if(boycheck.includes('한영고')){hanyeongplus = 10};
			if(girlcheck.includes('영파여고')){yeongpawomenplus = 10};
			if(girlcheck.includes('창덕여고')){changdeokwomenplus = 10};
			//if(girlcheck.includes('용화여고')){yonghwaplus = 10};
			if(boycheck.includes('잠실고')){jamsilplus = 10};
			if(boycheck.includes('동북고')){dongbukplus = 10};
			if(boycheck.includes('보성고')){boseongplus = 10};
			...
			/*
			var doonchonprior = ((prior * 0.1) + (prior * 0.7) + (prior * 0.1) + (prior * 0.3) + (prior * 0.1))/50; //13
			var hanyeongprior = ((prior * 0.1) + (prior * 0.3) + (prior * 0.4) + (prior * 0.6) + (prior * 0.8))/50; //22
			var yeongpawomenprior = ((prior * 0.7) + (prior * 0.6) + (prior * 0.7) + (prior * 0.3) + (prior * 0.1))/50; //24
			var changdeokwomenprior = ((prior * 0.3) + (prior * 0.1) + (prior * 0.1) + (prior * 0.2) + (prior * 0.1))/50; //8
			var yonghwaprior = ((prior * 0.1) + (prior * 0.3) + (prior * 0.1) + (prior * 0.1) + (prior * 0.2))/50; //8
			var jamsilprior = ((prior * 0.1) + (prior * 0.6) + (prior * 0.1) + (prior * 0.3) + (prior * 0.2))/50; //13
			var dongbukprior = ((prior * 0.1) + (prior * 0.3) + (prior * 0.5) + (prior * 0.1) + (prior * 0.1))/50; //11
			var boseongprior = ((prior * 0.2) + (prior * 0.7) + (prior * 1.1) + (prior * 0.6) + (prior * 0.6))/50; //32
			*/
			var doonchonprior;
			var hanyeongprior;
			var yeongpawomenprior;
			var changdeokwomenprior;
			//var yonghwaprior;
			var jamsilprior;
			var dongbukprior;
			var boseongprior;
			...
			if(prior >= 80) {
				...
				hanyeongprior = 5;
				changdeokwomenprior = 5;
				boseongprior = 5;
				
				yeongpawomenprior = 10;
				//yonghwaprior = 10;
				jamsilprior = 10;
			...
			if($('input:checkbox[name=girlcheck]').is(":checked") == true && $('input:checkbox[name=boycheck]').is(":checked") == false){
				var doonchonsum = (test1_1 * 3) + (test1_2 * 4) + (test1_3 * 2) + (test1_4 * 1) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 2) + (test1_10 * 0) + (test1_11 * 0) + (test1_12 * 2) + (test1_13 * 0) + (test1_14 * 1) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + doonchonprior + doonchonplus;
				var hanyeongsum = (test1_1 * 3) + (test1_2 * 3) + (test1_3 * 3) + (test1_4 * 1) + (test1_5 * 0) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 0) + (test1_10 * 0) + (test1_11 * 1) + (test1_12 * 0) + (test1_13 * 1) + (test1_14 * 1) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 1) + (transtest3_25 * 1) + hanyeongprior + hanyeongplus;
				var yeongpawomensum = (test1_1 * 2) + (test1_2 * 3) + (test1_3 * 3) + (test1_4 * 0) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 1) + (test1_9 * 1) + (test1_10 * 1) + (test1_11 * 0) + (test1_12 * 1) + (test1_13 * 0) + (test1_14 * 1) + (transtest3_13 * 1.3) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + yeongpawomenprior + yeongpawomenplus;
				var changdeokwomensum = (test1_1 * 5) + (test1_2 * 8) + (test1_3 * 5) + (test1_4 * 2) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 2) + (test1_10 * 0) + (test1_11 * 0) + (test1_12 * 1) + (test1_13 * 0) + (test1_14 * 0) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + changdeokwomenprior + changdeokwomenplus;
				...
				var doonchon = doonchonsum / (doonchonsum + hanyeongsum + yeongpawomensum + changdeokwomensum) * 100;
				var hanyeong = hanyeongsum / (doonchonsum + hanyeongsum + yeongpawomensum + changdeokwomensum) * 100;
				var yeongpawomen = yeongpawomensum / (doonchonsum + hanyeongsum + yeongpawomensum + changdeokwomensum) * 100;
				var changdeokwomen = changdeokwomensum / (doonchonsum + hanyeongsum + yeongpawomensum + changdeokwomensum) * 100;
				//var yonghwa = yonghwasum / (doonchonsum + hanyeongsum + yeongpawomensum + changdeokwomensum + yonghwasum + cheongwongirlssum) * 100;
			}
			if($('input:checkbox[name=girlcheck]').is(":checked") == false && $('input:checkbox[name=boycheck]').is(":checked") == true){
				var doonchonsum = (test1_1 * 3) + (test1_2 * 4) + (test1_3 * 2) + (test1_4 * 1) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 2) + (test1_10 * 0) + (test1_11 * 0) + (test1_12 * 2) + (test1_13 * 0) + (test1_14 * 1) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + doonchonprior + doonchonplus;
				var hanyeongsum = (test1_1 * 3) + (test1_2 * 3) + (test1_3 * 3) + (test1_4 * 1) + (test1_5 * 0) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 0) + (test1_10 * 0) + (test1_11 * 1) + (test1_12 * 0) + (test1_13 * 1) + (test1_14 * 1) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 1) + (transtest3_25 * 1) + hanyeongprior + hanyeongplus;
				var jamsilsum = (test1_1 * 2) + (test1_2 * 1) + (test1_3 * 3) + (test1_4 * 2) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 2) + (test1_10 * 0) + (test1_11 * 0) + (test1_12 * 0) + (test1_13 * 1) + (test1_14 * 0) + (transtest3_13 * 1.6) + (transtest3_14 * 2) + (transtest3_19 * 1) + (transtest3_25 * 2) + jamsilprior + jamsilplus;
				var dongbuksum = (test1_1 * 2) + (test1_2 * 3) + (test1_3 * 2) + (test1_4 * 1) + (test1_5 * 1) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 2) + (test1_9 * 0) + (test1_10 * 0) + (test1_11 * 0) + (test1_12 * 2) + (test1_13 * 0) + (test1_14 * 0) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + dongbukprior + dongbukplus;
				var boseongsum = (test1_1 * 1) + (test1_2 * 2) + (test1_3 * 1) + (test1_4 * 0) + (test1_5 * 0) + (test1_6 * 0) + (test1_7 * 0) + (test1_8 * 0) + (test1_9 * 1) + (test1_10 * 1) + (test1_11 * 0) + (test1_12 * 1) + (test1_13 * 1) + (test1_14 * 1) + (transtest3_13 * 1.1) + (transtest3_14 * 1) + (transtest3_19 * 0) + (transtest3_25 * 1) + boseongprior + boseongplus;
				var doonchon = doonchonsum / (doonchonsum + hanyeongsum + jamsilsum + dongbuksum + boseongsum) * 100;
				var hanyeong = hanyeongsum / (doonchonsum + hanyeongsum + jamsilsum + dongbuksum + boseongsum) * 100;
				var jamsil = jamsilsum / (doonchonsum + hanyeongsum + jamsilsum + dongbuksum + boseongsum) * 100;
				var dongbuk = dongbuksum / (doonchonsum + hanyeongsum + jamsilsum + dongbuksum + boseongsum) * 100;
				var boseong = boseongsum / (doonchonsum + hanyeongsum + jamsilsum + dongbuksum + boseongsum) * 100;
			}
			let today = new Date();
			...
			$.ajax({
				...
				data : {
					...
					schoolmatch_doonchon : doonchon,
					schoolmatch_hanyeong : hanyeong,
					schoolmatch_yeongpawomen : yeongpawomen,
					schoolmatch_changdeokwomen : changdeokwomen,
					//schoolmatch_yonghwa : yonghwa,
					schoolmatch_jamsil : jamsil,
					schoolmatch_dongbuk : dongbuk,
					schoolmatch_boseong : boseong,
