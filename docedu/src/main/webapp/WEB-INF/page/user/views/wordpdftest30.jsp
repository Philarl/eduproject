    ...
    <style>
        ...
        * {
        ...
        @media print {
            ...
            .bodyword{font-size: 10pt; transform: scale(0.7); text-align:left; margin-left: -20px; white-space: nowrap;}
            .bodytrans{font-size: 10pt; text-align: left; padding-left: 10px; overflow: hidden;}
            .bodyclass{font-size: 10pt; overflow: hidden;}
...
<body>
    ...
    <div class="imgarea">
        <div class="mainimg">
            <img class="mainimg1" alt="img1" src="/resources/img/user/단어pdf30-1.png">
        </div>
    ...
    <div class="imgarea">
        <div class="mainimg">
            <img class="mainimg2" src="/resources/img/user/단어pdf30-2.png">
        </div>
        <div class="namearea">
    ...
    <div class="imgarea">
        <div class="mainimg">
            <img class="mainimg3" alt="img3" src="/resources/img/user/단어pdf30-3.png">
        </div>
    </div>
