...
<body>
	<table>
		...
		<c:forEach var="list" items="${WordpdfList}" varStatus="status">
			<tr>
				<td onclick="location.href='wordpdf30.do?wpdf_header=${list.wpdf_header}'" style="text-decoration: underline;">
	...
	<table>
		...
		<c:forEach var="list" items="${WordpdfList}" varStatus="status">
			<tr>
				<td>
					<c:out value="${list.wpdf_header}" />
					<a href="wordpdftest30.do?wpdf_header=${list.wpdf_header}">시험지</a>
				</td>
			</tr>
		</c:forEach>
	</table>
