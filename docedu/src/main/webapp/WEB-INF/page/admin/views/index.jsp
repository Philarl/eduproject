        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseone" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="watchdisplay.html">출석 및 랭킹</a>
                        <a class="collapse-item" href="accessacademy.html">학습센터 정보</a>
                        <a class="collapse-item" href="tables.html">학습자 관리</a>
                        <a class="collapse-item" href="accessadmin.html">선생님 관리</a>
                        <a class="collapse-item" href="assignmentclass.html">반 편성 및 배정</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsecontents" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">목록</h6>
                        <a class="collapse-item" href="maincontent.html">전체 교재</a>
                        <a class="collapse-item" href="mainlecture.html">전체 강의</a>
                        <a class="collapse-item" href="mainhomework.html">전체 숙제</a>
                        <a class="collapse-item" href="assignmenthomework.html">숙제 배정</a>
                        <a class="collapse-item" href="studentindex.html">숙제 확인</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="insertnotice.html">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>공지 작성</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="speciallecture.html">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>특강 관리</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="notice.html">공지사항으로 이동</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="adminmessage.html">메세지함으로 이동</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="adminmessage.html">
                                ...
                                <div class="card-body">
                                    <div class="chart-area" style="height: auto;">
                                        <div class="contentsarea">
                                            <div class="contents" id="contentmenu" onclick="location.href='maincontent.html';">전체 교재</div>
                                            <div class="contents" id="tablesmenu" onclick="location.href='tables.html';">학습자 관리</div>
                                            <div class="contents" id="classdividemenu" onclick="location.href='assignmentclass.html';">반 배정/배정</div>
                                            <div class="contents" id="homeworkdividemenu" onclick="location.href='assignmenthomework.html';">숙제 배정</div>
                                            <div class="contents" id="homeworkcheckmenu" onclick="location.href='checkhomework.html';">숙제 확인</div>
                                            <div class="contents" id="sendmenu" onclick="location.href='sendmessage.html';">알림장 전송</div>
                                            <div class="contents" id="workmenu" onclick="location.href='workdivide.mdo';">직원 업무 관리</div>
                                            <div class="contents" id="watchmenu" onclick="location.href='watchdisplay.html';">출석 및 랭킹</div>
                                            <div class="contents" id="academymenu" onclick="location.href='accessacademy.html';">학습센터 정보</div>
                                            <div class="contents" id="teachermenu" onclick="location.href='accessadmin.html';">선생님 관리</div>
                                            <div class="contents" id="acceptancemenu" onclick="location.href='#';">수납 관리</div>
                                            <div class="contents" id="lecturemenu" onclick="location.href='mainlecture.html';">전체 강의</div>
                                            <div class="contents" id="homeworkmenu" onclick="location.href='mainhomework.html';">전체 숙제</div>
                                            <div class="contents" id="noticemenu" onclick="location.href='notice.html';">공지사항</div>
                                            <div class="contents" id="datamenu" onclick="location.href='#';">자료실</div>
                                            <div class="contents" id="supplementmenu" onclick="location.href='supplement.html';">보충강의 관리</div>
                                            <div class="contents" id="insertnoticemenu" onclick="location.href='insertnotice.html';">공지 작성</div>
                                            <div class="contents" id="specialmenu" onclick="location.href='speciallecture.html';">특강 관리</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
